...
class HousePackage extends React.Component{
    ...
    renderItems() {
        ...
        return data.map(item => {
                ...
                return (
                    <li
                        key={item.id}
                        className={["housepackage-item", isSelected ? "housepackage-active" : ""].join(" ")}
                        onClick={select && (() => this.toggleSelect(item.name))}>
                        <p>
                            <i className={["iconfont", item.icon, "housepackage-icon"].join(" ")} ></i>
                        </p>
                        {item.name}
                    </li>
                )
    ...
    render() {
        return (
            <ul className="housepackage-root">
                {this.renderItems()}
            </ul>
        )
